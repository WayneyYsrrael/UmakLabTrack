...
// eto yung white card na laman yung info
import androidx.compose.foundation.BorderStroke
import androidx.compose.foundation.background
import androidx.compose.foundation.clickable
import androidx.compose.foundation.layout.* // Imports fillMaxHeight, etc.
    ...
    Dialog(
        ...
        Card(
            modifier = Modifier
                ...
                .fillMaxHeight(0.85f),  // <--- CHANGED: 85% Height (Makes it longer)
            ...
            Column(
                ...
                // ================= SCROLLABLE CONTENT =================
                // The weight(1f) here is crucial; it allows this section to expand
                // to fill the newly added height.
                LazyColumn(
                    modifier = Modifier
                        .weight(1f)
